...
class EventSerializer(serializers.ModelSerializer):
    ...
    occurrence_date_f = serializers.DateField(source='occurrence_date', format="%d-%m-%Y")
    created_date_f = serializers.DateTimeField(source='created_date', format="%d-%m-%Y (%I:%M %p)")
