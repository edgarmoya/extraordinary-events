...
function CardAttachment({ id, imageUrl, onDelete, readOnly }) {
      ...
      >
        ...
        {!readOnly && (
          <button
            ...
            type="button"
            onClick={() => onDelete(id)}
            className="position-absolute border-0 p-0 end-0 top-0 d-flex justify-content-center align-items-center btn-close-bg btn-accions-blue m-1"
          >
            <svg
