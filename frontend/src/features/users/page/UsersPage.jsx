  ...
  return (
    <Layout pageTitle="Usuarios">
          ...
          <TopBar.Button
            ...
            onClick={() => {
              if (selectedRow) {
                ...
                showErrorToast("Seleccione el usuario que desea editar");
              }
            }}
          />
          <TopBar.Button
      ...
      <ModalConfirmDelete
        ...
        message={`Está a punto de eliminar el usuario "${selectedRow?.user_name}". ¿Desea continuar?`}
        loading={deleting}
      />
      ...
      <ModalConfirmActivate
        ...
        } el usuario "${selectedRow?.user_name}". ¿Desea continuar?`}
        loading={activating}
      />
