  ...
  return (
    <Layout pageTitle="Sectores">
          ...
          <TopBar.Button
            ...
            onClick={() => {
              if (selectedRow) {
                ...
                showErrorToast("Seleccione el sector que desea editar");
              }
            }}
            icon={UpdateIcon}
          />
      ...
      <ModalConfirmDelete
        ...
        message={`Está a punto de eliminar el sector "${selectedRow?.description}". ¿Desea continuar?`}
        loading={deleting}
      />
      ...
      <ModalConfirmActivate
        ...
        } el sector "${selectedRow?.description}". ¿Desea continuar?`}
        loading={activating}
      />
    </Layout>
  );
